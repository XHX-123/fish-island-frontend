 ...
 * 验证码地址
 */
// export const BACKEND_HOST_CODE = 'http://localhost:8123/api';
export const BACKEND_HOST_CODE = 'https://fish.codebug.icu/fish/api';
export const BACKEND_HOST_WS = 'wss://fish.codebug.icu/ws/?token=';
